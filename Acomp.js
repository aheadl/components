...
const gg = PARTNERS.map(partner => {
    return (      
        <RenderPartner key={partner.id} partner={partner} />
       
       
      );
    });
    console.log("PARTNERS IS", gg);

// const partnerList = props.partners.map(partner => {
//     return (
//         <RenderPartner key={partner.id} partner={partner} />
//       );
//   });
...
function RenderPartner({partner}) {
    if (partner) {
        ...
        //             <h3>Community Partners for Andrea</h3>
        //          </div>
